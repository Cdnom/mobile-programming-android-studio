...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        targetET = (EditText) findViewById(R.id.targetEditText);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.sentButton:
                System.out.println("testing raymond");
                String phoneNumber = targetET.getText().toString();
            ...
            public void onReceive(Context arg0, Intent arg1) {
                switch (getResultCode()) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Toast.makeText(getBaseContext(), "SMSTidak Terkirim", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
